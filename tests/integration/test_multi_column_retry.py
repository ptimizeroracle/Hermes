...
class TestMultiColumnRetry:
    ...
    def test_retry_detects_failures_in_all_output_columns(self, mock_groq_class):
        """
    ...
    @patch("hermes.adapters.llm_client.GroqClient")
    def test_retry_continues_until_all_columns_valid_or_max_attempts(
        self, mock_groq_class
    ):
        """
